import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Input, OnChanges, forwardRef } from '@angular/core';
...
@Component({
    selector: 'polaris-dashboards-list',
...
export class DashboardsListComponent implements OnChanges, ControlValueAccessor {
